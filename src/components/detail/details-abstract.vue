...
export default {
  ...
  mounted() {
    ...
    function crystalPrepare(cifUrl) {
      ...
      viewer = ChemDoodle.TransformCanvas3D("chemIframe", 400, 400);
      viewer.styles.set3DRepresentation("Ball and Stick");
      viewer.styles.backgroundColor = "#EEF5FF";
      viewer.styles.projectionPerspective_3D = false;
      viewer.styles.shapes_color = "black";
      viewer.styles.atoms_useJMOLColors = true;
      viewer.styles.compass_display = true;
      viewer.styles.compass_size_3D = 40;
      jQuery.ajax({
        type: "get",
        url: cifUrl,
        async: false,
